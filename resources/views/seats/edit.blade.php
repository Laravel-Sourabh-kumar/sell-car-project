...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
            {{ Form::model($seats, array('route' => array('seats.update', $seats->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::number('seat_number',null, array('placeholder' => 'seat_number','class' => 'form-control w-100','required'=>'')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::textarea('seat_detail',null, array('placeholder' => 'seat_detail','class' => 'form-control w-100','required'=>'')) !!}
