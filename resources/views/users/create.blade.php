            ...
            <div class="card-body">
                <form action="{{ route('users.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="tel" maxlength="10" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" value="{{ old('mobile') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="tel" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address') }}">
