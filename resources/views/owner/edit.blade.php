...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
            {{ Form::model($owner, array('route' => array('owner.update', $owner->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::text('owner_type',null, array('placeholder' => 'owner_type','class' => 'form-control w-100','required'=>'')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::textarea('owner_detail',null, array('placeholder' => 'owner_Detail','class' => 'form-control w-100' )) !!}
