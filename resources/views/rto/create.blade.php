...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
            {!! Form::open(array('route' => 'rto.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::text('rto_full_name','', array('placeholder' => 'rto_full_name','class' => 'form-control w-100','required'=>'')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::text('rto_short_name','', array('placeholder' => 'rto_short_name','class' => 'form-control w-100','required'=>'')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::text('rto_address','', array('placeholder' => 'rto_address','class' => 'form-control w-100','required'=>'')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::number('rto_pincode','', array('placeholder' => 'rto_pincode','class' => 'form-control w-100','required'=>'')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::text('rto_state','', array('placeholder' => 'rto_state','class' => 'form-control w-100','required'=>'')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::text('rto_city','', array('placeholder' => 'rto_city','class' => 'form-control w-100','required'=>'')) !!}
