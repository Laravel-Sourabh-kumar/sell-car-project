    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    <a href="{{route('fuel-type.index')}}" class="btn btn-primary btn-sm">&larr; Back</a>
                </div>
            </div>
            <div class="card-body">
            {{ Form::model($fueltype, array('route' => array('fuel-type.update', $fueltype->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
