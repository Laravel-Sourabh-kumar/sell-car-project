...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
            {!! Form::open(array('route' => 'kms-driven.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::number('kms','', array('placeholder' => 'kms Driven','class' => 'form-control w-100','required'=>'','maxlength'=>'4',"pattern"=>"\d{4}")) !!}
                            @if ($errors->has('kms'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        {!! Form::textarea('detail','', array('placeholder' => 'Detail','class' => 'form-control w-100')) !!}
